<h2 style="margin:0 0 16px;font-size:18px;color:#111827;">Neues Ticket eingegangen</h2>
...
<tr><td>
    ...
    <p style="margin:0 0 12px;color:#6b7280;font-size:14px;">Kunde: <?php echo esc_html($client_name); ?></p>
    <p style="margin:0;color:#374151;font-size:14px;line-height:1.5;">{{description}}</p>
</td></tr>
</table>
