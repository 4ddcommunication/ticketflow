<h2 style="margin:0 0 16px;font-size:18px;color:#111827;"><?php esc_html_e('Ticket Status Updated', 'ticketflow'); ?></h2>
...
<p style="margin:0 0 16px;color:#374151;line-height:1.6;">
    <?php printf(esc_html__('The status of ticket %s has been updated.', 'ticketflow'), '<strong>' . esc_html($ticket_uid) . '</strong>'); ?>
</p>
